...
/*   Updated: 2023/02/17 11:23:40 by victgonz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
	...
	i = printf("%0 10.5d, %0 10.5d, %0 10.5d, %0 10.5d, %0 10.5d, %0 10.5d, %0 10.5d, %0 10.5d\n", 0, 5, -1, -10, 100, -1862, INT_MIN, INT_MAX);
	j = ft_printf("%0 10.5d, %0 10.5d, %0 10.5d, %0 10.5d, %0 10.5d, %0 10.5d, %0 10.5d, %0 10.5d\n", 0, 5, -1, -10, 100, -1862, INT_MIN, INT_MAX);
	printf("%u %u\n", i, j);
